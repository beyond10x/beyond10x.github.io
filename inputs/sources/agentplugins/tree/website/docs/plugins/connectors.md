...
Release `0.9.0` includes this plugin. For a fresh marketplace registration, use the release pin:

```bash
claude plugin marketplace add https://github.com/beyond10x/agentplugins.git#0.9.0
